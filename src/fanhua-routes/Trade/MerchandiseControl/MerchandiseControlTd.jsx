        ...
        <div>
          <Row className={'table-other-line'} type="flex" align="middle">
            ...
            <Col span={6} >
              ...
              <p>提货方式:{item.deliver_type==0? "配送":"自提"}</p>
            </Col>
            {/*<Col span={1}>*/}
            {/*</Col>*/}
            <Col span={3}>
            ...
            <Col span={5}>
              <div style={{marginBottom:'3px'}} className={'my-customer-table-title'}>
                {item.status==0 ? <span  onClick={this.onChange}><Icon type="down-circle-o" style={{marginRight:'5px'}}/>下架</span>
                :<span onClick={this.onChange}><Icon type="down-circle-o" style={{marginRight:'5px'}}/>上架</span>}
              </div>
