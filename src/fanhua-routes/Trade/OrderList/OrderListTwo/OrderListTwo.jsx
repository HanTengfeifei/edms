...
import OrderListTable from './OrderListTableTwo' ;
import ChooseOrderTypeTwo from './ChooseOrderTypeTwo' ;
...
class OrderList extends React.Component {
  ...
  componentDidMount(){
    RequireUtils.baseRequire('order/order-num',{kind:2},function (data){
      if(data.code==1) {
        this.setState({
    ...
    return (
      <div onKeyDown={(e)=>this.myselfonkeydown.bind(this)(e)}>
         <Row gutter={8} style={{ marginTop: '10px' }}>
          <Col span={24}>
            ...
            <Row gutter={8} style={{ marginTop: '10px',marginBottom:'10px' }} type="flex" justify='space-between' className={'my-customer-car'}>
              ...
              <Col span={3} >
                <Card bordered={false} onClick={()=>this.showTableByType('5')}>
                  <div className="custom-image">
                    <Badge count={0}>
              ...
              <Row gutter={8} style={{ marginTop: '10px' }}>
                <Col span={24} >
                  <div style={{marginBottom:'10px',textAlign:'right'}}>
                    <Link to="/addorderallbuyer"> <span style={{color:'rgba(0, 0, 0, 0.65)',marginRight:'8px'}}>
                       <Icon type="plus-circle-o"  style={{marginRight:'8px'}}/>
                        添加线下采购订单
                    </span></Link>
                    <Link to="/addOrderallsaler"> <span style={{color:'rgba(0, 0, 0, 0.65)',marginRight:'8px'}}>
                       <Icon type="plus-circle-o"  style={{marginRight:'8px'}}/>
                        添加线下销售订单
                    </span></Link>
                  </div>
        ...
        <Modal title="添加订单"
               ...
               footer={null}>
          <ChooseOrderTypeTwo ref={'ChooseOrderType'} cancelOrderMark={this.cancelOrderMark.bind(this)} ></ChooseOrderTypeTwo>
        </Modal>
      </div>
    )
  }
