              ...
              <Col span={3} >
                <Card hoverable bordered={false} onClick={()=>this.showTableByType('')}>
                  <div className="custom-image" >
                       <Badge count={0}>
                          {/*<Icon type="appstore"   style={{fontSize:'40px',marginBottom:'10px',color:'#096dd9'}}/>*/}
                         {
                ...
                <Card hoverable bordered={false} onClick={()=>this.showTableByType('0')}>
                  <div className="custom-image">
                    <Badge count={dstatusdnum.daiquren?dstatusdnum.daiquren:0}>
                      {/*<Icon type="clock-circle" spin={true} style={{fontSize:'40px',marginBottom:'10px',color:'#faad14'}}/>*/}
                      {
              ...
              <Row gutter={8} style={{ marginTop: '10px' }}>
                <Col span={24} >
                  <div style={{marginBottom:'10px',textAlign:'right'}}>
                    <Link to="/AddOrderAll"> <span style={{color:'rgba(0, 0, 0, 0.65)',marginRight:'8px'}}>
