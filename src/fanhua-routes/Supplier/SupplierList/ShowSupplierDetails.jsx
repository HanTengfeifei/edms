...
class ShowCustomerDetails extends React.Component {
  ...
  render() {
    ...
    return (
      <div >
        <Card hoverable title="供应商详情" type="card">
            ...
            <Col style={{fontSize:'16px',color:'black',marginBottom:'10px'}}>
              <div>
                ...
                <span style={{float:'right',marginRight:'10px'}}>
                  ...
                  <span><span style={{fontSize:'14px',fontWeight:100}}>累计销售量&nbsp;</span><span className={'my-customer-color'}>{statistics.total_num}吨</span></span>
                </span>
              </div>
            </Col>
          </Row>
